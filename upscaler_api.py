...
def upscale_image():
    ...
    # Load the workflow
    try:
        with open('upscaler_workflow.json', 'r') as f:
    ...
    try:
        workflow['84']['inputs']['image'] = image_base64
        workflow['45']['inputs']['seed'] = seed
        workflow['86']['inputs']['filename_prefix'] = f"BackgroundReplacerUPSCALEDplusseed_{seed}"
    ...
    for filename in os.listdir(output_dir):
        if filename.startswith(f"BackgroundReplacerUPSCALEDplusseed_{seed}") and filename.endswith(".png"):
